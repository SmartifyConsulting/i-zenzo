...
function ExecutionList() {
  ...
  return (
    <>
      ...
      <h1 className="text-2xl font-semibold text-slate-900">Execution Engine</h1>
      ...
      <div className="mt-6 rounded-lg border border-slate-200 bg-slate-50">
        <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3">
          <div className="text-sm font-medium text-slate-900">Execution cases ({cases.length})</div>
            ...
            <tbody>
              ...
              {cases.map((c) => (
                <tr key={c.id} className="border-b border-slate-100 text-slate-700">
                  <td className="px-4 py-2.5 font-mono text-[11px] text-slate-800">{c.transaction_id.slice(0, 8)}…</td>
