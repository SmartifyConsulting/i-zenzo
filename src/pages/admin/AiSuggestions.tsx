    ...
    <>
      ...
      <div className="mt-6 rounded-lg border border-white/10 bg-white/[0.02]">
        <div className="border-b border-white/10 px-4 py-3">
          <div className="text-sm font-medium text-slate-100">AI launcher</div>
        ...
        {sourceError && <p className="border-b border-white/10 px-4 py-2 text-xs text-red-400">{sourceError}</p>}
      </div>
