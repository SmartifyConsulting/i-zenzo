...
function Queue() {
  ...
  return (
    <>
      ...
      <h1 className="text-2xl font-semibold text-slate-900">Bank verification, review queue</h1>
      ...
      <div className="mt-6 rounded-lg border border-slate-200 bg-slate-50">
        <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3">
          <div className="text-sm font-medium text-slate-900">Verification requests ({rows.length})</div>
